...
import com.github.yvescheung.whisperlint.ast.getAvailableCaller
import com.github.yvescheung.whisperlint.ast.getAvailableReturnValue
...
class WhisperUseWithDetector : Detector(), Detector.UastScanner {
    ...
    override fun visitAnnotationUsage(
        ...
        val useWithStr = AnnotationCompat.getAnnotationStringValue(annotation, "value")
            ?: return
