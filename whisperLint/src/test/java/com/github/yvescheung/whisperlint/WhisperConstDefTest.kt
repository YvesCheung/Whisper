    ...
    fun `Check intDef in Kotlin function param with int array`() {
        lint().files(
            ...
            .expect("src/aa/A.kt:9: Error: Must be one of [1, 3, 4], but actual [5] [WhisperConstDef]\n" +
                ...
                "        val reference = arrayOf(5, 1, 3, 4, 6)\n" +
                "                                ~\n" +
                "    src/aa/A.kt:12: Here's the @com.github.yvescheung.whisper.IntDef value.\n" +
    ...
    fun `Check intDef in Kotlin function param with call expression`() {
        lint().files(
            ...
            .expect("src/aa/A.kt:16: Error: Must be one of [4, 5], but actual [6] [WhisperConstDef]\n" +
                ...
                "    private fun return13(): Int = 13\n" +
                "                                  ~~\n" +
                "    src/aa/A.kt:11: Here's the @com.github.yvescheung.whisper.IntDef value.\n" +
                "2 errors, 0 warnings")
    }
    ...
    fun `Check intDef in Kotlin function return value`() {
        lint().files(
            ...
            .expect("src/aa/A.kt:14: Error: Must be one of [1, 2, 3], but actual [5] [WhisperConstDef]\n" +
                "        val b = 5\n" +
                "                ~\n" +
                "    src/aa/A.kt:15: Here's the @com.github.yvescheung.whisper.IntDef value.\n" +
    ...
    fun `Check intDef in Java function param`() {
        lint().files(
            ...
            .expect("src/aa/A.java:16: Error: Must be one of [1, 3, 5], but actual [4] [WhisperConstDef]\n" +
                ...
                "        int reference = 6;\n" +
                "                        ~\n" +
                "    src/aa/A.java:25: Here's the @com.github.yvescheung.whisper.IntDef value.\n" +
                "5 errors, 0 warnings")
    }
