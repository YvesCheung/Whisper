...
import com.github.yvescheung.whisperlint.WhisperHintDetector
...
class WhisperHintTest {
    ...
    fun `Check Need Error Method`() {
        ...
        lint().files(
            ...
            .run()
            .expect("src/com/github/yvescheung/TestClass.java:12: Error: i am test [WhisperError]\n" +
                "       function();\n" +
                "       ~~~~~~~~~~\n" +
                "src/com/github/yvescheung/TestClass2.java:5: Error: i am test [WhisperError]\n" +
                "       new TestClass().function();\n" +
                "       ~~~~~~~~~~~~~~~~~~~~~~~~~~\n" +
                "2 errors, 0 warnings")
    }
    ...
    fun `Check Need Warning Method`() {
        ...
        lint().files(
            ...
            java("""
                ...
                |public class TestClass {
                |
                |   @com.github.yvescheung.whisper.NeedWarning("i am test")
                |   public int function() {
                |       return 3;
                |   }
                |
            ...
            kotlin("""
                ...
                |class TestKotlin {
                |
                |   private val aCls = com.github.yvescheung.TestClass()
                |
            ...
            .detector(WhisperHintDetector())
            .run()
            .expect("src/com/github/yvescheung/TestClass.java:11: Warning: i am test [WhisperWarning]\n" +
                "       int a = function();\n" +
                "               ~~~~~~~~~~\n" +
                "src/com/github/yvescheung/whisper/TestKotlin.kt:7: Warning: i am test [WhisperWarning]\n" +
                "   fun method():Int = aCls.function()\n" +
                "                      ~~~~~~~~~~~~~~~\n" +
                "0 errors, 2 warnings")
    }
    ...
    fun `Check Need Info field`() {
        ...
        lint().files(
            ...
            java("""
                ...
                |
                |   @com.github.yvescheung.whisper.NeedInfo("what the fuck")
    ...
    fun `Check Kotlin method`() {
        lint().files(
            ...
            .detector(WhisperHintDetector())
            .run()
            .expect("src/com/github/yvescheung/ClassTest2.kt:31: Error: This method should show error [WhisperError]\n" +
                "           instance.error()\n" +
                "           ~~~~~~~~~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:31: Error: This method should show error [WhisperError]\n" +
                "           instance.error()\n" +
                "           ~~~~~~~~~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:29: Information: This method should show info [WhisperInfo]\n" +
                "           instance.info()\n" +
                "           ~~~~~~~~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:29: Information: This method should show info [WhisperInfo]\n" +
                "           instance.info()\n" +
                "           ~~~~~~~~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:30: Warning: This method should show warning [WhisperWarning]\n" +
                "           instance.warning()\n" +
                "           ~~~~~~~~~~~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:30: Warning: This method should show warning [WhisperWarning]\n" +
                "           instance.warning()\n" +
    ...
    fun `Check method with annotation parameter`() {
        lint().files(
            ...
            .detector(WhisperHintDetector())
            .run()
            .expect("src/com/github/yvescheung/ClassTest1.java:13: Error: this is method3 [WhisperError]\n" +
                "       instance.method3(instance);\n" +
                "                        ~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:20: Error: this is method3 [WhisperError]\n" +
                "           instance.method3(instance);\n" +
                "                            ~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:20: Error: this is method3 [WhisperError]\n" +
                "           instance.method3(instance);\n" +
                "                            ~~~~~~~~\n" +
                "src/com/github/yvescheung/ClassTest1.java:11: Information: this is method1 [WhisperInfo]\n" +
                "       instance.method1(\"a\");\n" +
                "                        ~~~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:18: Information: this is method1 [WhisperInfo]\n" +
                "           instance.method1(\"a\");\n" +
                "                             ~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:18: Information: this is method1 [WhisperInfo]\n" +
                "           instance.method1(\"a\");\n" +
                "                             ~\n" +
                "src/com/github/yvescheung/ClassTest1.java:12: Warning: this is method2 [WhisperWarning]\n" +
                "       instance.method2(2);\n" +
                "                        ~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:19: Warning: this is method2 [WhisperWarning]\n" +
                "           instance.method2(2);\n" +
                "                            ~\n" +
                "src/com/github/yvescheung/ClassTest2.kt:19: Warning: this is method2 [WhisperWarning]\n" +
                "           instance.method2(2);\n" +
